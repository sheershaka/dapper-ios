...
@IBDesignable open class MadokaTextField: TextFieldEffects {
    ...
    private let placeholderInsets = CGPoint(x: 15, y: 4)
    private let textFieldInsets = CGPoint(x: 15, y: 10)
    ...
    override open func animateViewsForTextEntry() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            let translate = CGAffineTransform(translationX: 0, y: self.placeholderLabel.bounds.height + (self.placeholderInsets.y * 1.8))
